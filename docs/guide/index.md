...
如果我们需要绘制一条曲线的话 我们在添加一条线段

![image](https://user-images.githubusercontent.com/66500121/213386598-fc754279-4cbf-4acc-8547-a7d455c01ab4.png)

我们需要做的就是添加另一个线性插值 在 P1 和 P2 之间

然后在 L0 和 L1 之间继续进行线性插值 lerp

Q0 就是我们需要的值 然后我们追踪 Q0 的路径
